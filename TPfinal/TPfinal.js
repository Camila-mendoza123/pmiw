// https://youtu.be/qtthQOFzwWI 
//profe disculpe que mi video suene asi es que creo que es la compu y como no tengo un microfono suena asi no supe como arrglarlo
...
function draw() {
  ...
  if (estado !== 0 && estado !== 24 && estado !== 25) { //texto en un recuadro
    if (
...
function mousePressed() {
  ...
  //detecta en que posicion hizo el click
  if (estado === 3) {
